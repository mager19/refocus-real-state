...
<div class="container mx-auto py-14">
    <div class="info">
        <div class="text-center entry-author">
            ...
            <div class="info-author">
                ...
                <div class="title-page">
                    <span class="uppercase"><?php _e('About author', 'refocus_real_focus'); ?></span>
                    ...
                    <div class="social-icons">
                        ...
                        ?>
                                <a href="<?php the_sub_field('social_profile'); ?>" target="_blank" data-link-type="social" data-social-network="<?php echo $social['value']; ?>">
                                    <span class="refocus_real_focusIcon-<?php echo $social['value']; ?>"></span>
                                </a>
                        <?php endwhile;
                        endif; ?>
                    </div>
                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                    ...
                    <div class="info-post">
                        ...
                        <a href="<?php the_permalink(); ?>" class="link">
                            <?php _e('Continue Reading', 'refocus_real_focus'); ?>
                        </a>
                    </div>
                </article>
                <!-- Item Post -->
        ...
        <!-- Pagination -->
        <?php if (function_exists('refocus_real_focus__pagination')) : ?>
