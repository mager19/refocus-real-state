<?php
if (!function_exists('refocus_real_focus')) :
    /**
     ...
     */
    function refocus_real_focus()
    {
        /*
    * Make theme available for translation.
    * Translations can be filed in the /languages/ directory.
    * If you're building a theme based on Inspect It First, use a find and replace
    * to change 'refocus_real_focus' to the name of your theme in all the template files.
    */
        load_theme_textdomain('refocus_real_focus', get_template_directory() . '/languages');
    ...
    */
        ...
        register_nav_menus(array(
            'menu-1' => esc_html__('Header', 'refocus_real_focus'),
            'menu-2' => esc_html__('Footer', 'refocus_real_focus'),
        ));
...
add_action('after_setup_theme', 'refocus_real_focus');
...
function refocus_real_focus_get_social_icons()
{
